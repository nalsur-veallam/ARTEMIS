...
SOURCE_SECOND_MAP="../glucokinase/analysis/alfmap.json" # Path to second matrix for comparison

SOURCE_FIRST_INTEN="../glucokinase/compare_glu/glu_1_intensity.json" # Path to first json file with intensities for comparison
SOURCE_SECOND_INTEN="../glucokinase/compare_glu/glu_2_intensity.json" # Path to second json file with intensities for comparison
...
${PYTHON} src/python/matrix_comparison.py -f1 ${SOURCE_FIRST_MAP} -f2 ${SOURCE_SECOND_MAP} -o mat_comp  # Calculates the Frobenius norm of matrices and draws the difference matrix 
